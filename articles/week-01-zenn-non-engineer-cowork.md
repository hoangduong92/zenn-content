...
- ❌ 実際に失敗したこと3つと、その具体的な対処法
- 📋 そのままコピペで使えるプロンプトテンプレート5選
:::
...
![デスクトップのcowork-demoフォルダ](/images/week-01-zenn/screenshot-05.jpg)
...
![生成されたメモファイル — ファイルアクセス許可](/images/week-01-zenn/screenshot-06a.png)

![生成されたメモファイル — ファイル内容確認](/images/week-01-zenn/screenshot-06b.png)
...
![整理前 — 51個のファイルがバラバラ](/images/week-01-zenn/screenshot-07-before.png)

**整理後：** 4つのフォルダに自動分類
![整理後 — 4つのフォルダに自動整理](/images/week-01-zenn/screenshot-07-after.png)
...
良いことばかり書いても信頼されないので、正直に微妙だった点も書きます。
